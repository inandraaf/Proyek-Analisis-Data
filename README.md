...
[E-Commerce Data Dashboard Streamlit App](https://dashboardina.streamlit.app/)
...
```
git clone https://github.com/inandraaf/Proyek-Analisis-Data.git
```
...
```
cd Proyek-Analisis-Data-main/dashboard
